...
import com.example.modelo.Checkin;
...
public class CheckinHome {
	...
	private static final Log log = LogFactory.getLog(CheckinHome.class);
	...
	public void persist(Checkin transientInstance) {
		log.debug("persisting Checkin instance");
		try {
	...
	public Checkin merge(Checkin detachedInstance) {
		...
		try {
			Checkin result = (Checkin) sessionFactory.getCurrentSession()
	...
	public Checkin findById(long id) {
		...
		try {
			Checkin instance = (Checkin) sessionFactory.getCurrentSession()
					.get("Checkin", id);
			if (instance == null) {
	...
	public List findByExample(Checkin instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Checkin").add(Example.create(instance))
					.list();
