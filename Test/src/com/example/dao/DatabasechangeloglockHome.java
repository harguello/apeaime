...
import com.example.modelo.Databasechangeloglock;

/**
 * Home object for domain model class Databasechangeloglock.
 * @see .Databasechangeloglock
 * @author Hibernate Tools
 */
public class DatabasechangeloglockHome {

	private static final Log log = LogFactory
			.getLog(DatabasechangeloglockHome.class);
	...
	public Databasechangeloglock merge(Databasechangeloglock detachedInstance) {
		...
		try {
			Databasechangeloglock result = (Databasechangeloglock) sessionFactory
	...
	public Databasechangeloglock findById(int id) {
		...
		try {
			Databasechangeloglock instance = (Databasechangeloglock) sessionFactory
					.getCurrentSession().get("Databasechangeloglock", id);
			if (instance == null) {
	...
	public List findByExample(Databasechangeloglock instance) {
		log.debug("finding Databasechangeloglock instance by example");
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Databasechangeloglock")
